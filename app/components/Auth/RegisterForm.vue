  ...
  <div class="register-form">
    ...
    <form :class="['auth-form', { 'has-error': !!error }]" @submit.prevent="handleRegister">
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          ...
          <input
            ...
            :class="{ 'input-error': error && !formData.name }"
            placeholder="请输入您的姓名"
            required
            type="text"
            @input="clearError"
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          ...
          <input
            ...
            :class="{ 'input-error': error && !formData.username }"
            placeholder="请输入用户名"
            required
            type="text"
            @input="clearError"
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          ...
          <input
            ...
            :class="{ 'input-error': error && !formData.password }"
          ...
          <button type="button" class="password-toggle" @click="showPassword = !showPassword">
            <svg v-if="showPassword" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path d="M17.293 13.293A8 8 0 0 1 12 15c-3.866 0-7-1.79-7-4a6.968 6.968 0 0 1 1.512-4.188" />
              <path d="m2 2 20 20" />
            </svg>
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          ...
          <select
            ...
            :class="{ 'input-error': error && !formData.grade }"
            required
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          <svg class="input-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path d="M6 3h12l2 2v14l-2 2H6l-2-2V5l2-2z" />
            <path d="M9 9h6" />
            <path d="M9 12h6" />
            <path d="M9 15h6" />
          </svg>
          <select
            ...
            :class="{ 'input-error': error && !formData.class }"
...
const classOptions = computed(() => {
  ...
  const gradeClassMap: Record<string, number[]> = {
    '初2028届': Array.from({ length: 20 }, (_, i) => i + 1),
    '初2027届': Array.from({ length: 22 }, (_, i) => i + 1),
    '初2026届': Array.from({ length: 22 }, (_, i) => i + 1),
    '高2028届': Array.from({ length: 6 }, (_, i) => i + 1),
    '高2027届': Array.from({ length: 5 }, (_, i) => i + 1),
  }

  return gradeClassMap[formData.value.grade] || []
})
